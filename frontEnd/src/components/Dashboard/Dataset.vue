      ...
      <div class="d-flex justify-end">
        <div class="actions-container" @click="showActions = true" v-click-outside="onClickOutside">
          ...
          <div v-show="showActions" class="actions-content">
            ...
            <v-divider></v-divider>
            <router-link :to="{ name: 'dataset-edit', params: { id: this.$route.params.id }}" tag="div" class="actions-content--row">
              <EditIcon class="mr-2" />
              <span>Edit</span>
            </router-link>
            <v-divider></v-divider>
        ...
        <v-card>
          ...
          <v-card-text>
            <div class="form-group">
              ...
              <input
                type="text"
                class="field"
                placeholder="Visual Analytics name"
                id="analytics-name"
          ...
          <div class="upload-controls">
            <button
              ...
              :disabled="!analyticsName || isCreatingVA"
            >
...
<script>
  ...
  import { getMyIP, getTableauToken, getDatasetById, getItemsSample, createVA } from '@/api_client.js';
  ...
  export default {
    ...
    created() {
      ...
      getItemsSample(this.$route.params.id)
        .then(({ data }) => data)
        .catch(error => console.error(error))
    }
  }
