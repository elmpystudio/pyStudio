<template>
    <div class="my-container">
        ...
        <CInput :id="password.id" :type="password.type" :placeholder="password.placeholder" :iconName="password.iconName"
            :value="password.value" :rules="password.rules" @onChange="handleInput" />
